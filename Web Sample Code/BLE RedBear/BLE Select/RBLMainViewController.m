...
unsigned const MAX_INACTIVITY = 4;
...
-(void) bleDidReceiveData:(unsigned char *)data length:(int)length
{
        ...
        switch (_oemBuffer.data[0]) {
            case OEM_PULSE:
                if (_bufferIndex == NUM_PULSE_BYTES)
                {
                    ...
                    sesionStatuLabel.text = @"Sesion Started";
                    intervalLabel.text = [NSString stringWithFormat:@"Interval %d", interval];
                    _bufferIndex = 0;
                    _inactivityCount = 0;
                }
            ...
            case SYNC_CHAR:
                ...
                // this is just a sync char - send one back
                [bleShield write:[NSString stringWithFormat:@"%c", SYNC_CHAR]];
                break;
    ...
    {
        intervalLabel.text = @"";
        sesionStatuLabel.text = @"Sesion Ended";
    }
...
- (void) bleDidDisconnect
{
    ...
    self.rssiLabel.text = @"";
    sesionStatuLabel.text = @"Disconected";
...
-(void) bleDidConnect
{
    ...
    self.uuidLabel.text = self.lastUUID;
    self.rssiLabel.text = @"";
    sesionStatuLabel.text = @"Device Connected";
